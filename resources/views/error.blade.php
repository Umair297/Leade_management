  ...
  <body>
    ...
    <div class="container-xxl container-p-y">
      <div class="misc-wrapper">
        ...
        <a href="{{route('login')}}" class="btn btn-primary mb-10"  style="background-color: #008B98;">Back to Login</a>
        <div class="mt-4">
          <img
            src="public/assets/img/illustrations/page-misc-error.png"
            alt="page-misc-error"
            width="225"
            class="img-fluid" />
        </div>
